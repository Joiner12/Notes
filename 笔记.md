...
舰船电子http://jckxnet.toug.com.cn/

导航与控制 http://dhykz.zghtqk.com/ch/index.aspx

计算机与数字 http://jsjyszgc.soripan.net/buy/

上交 http://xuebao.sjtu.edu.cn/CN/column/column6.shtml

计算机应用 http://www.joca.cn/CN/column/column118.shtml

自动化学报 http://aas.net.cn/CN/volumn/current.shtml

火力与指挥控制 http://hlyzhk.goooc.net/

信息与控制 http://ic.sia.cn/CN/volumn/home.shtml

控制理论与应用 http://jcta.alljournals.ac.cn/cta_cn/ch/first_menu.aspx?parent_id=11

> ```
> 投稿指南
> 《上海交通大学学报》 （即自然科学版）是由国家教育部主管、上海交通大学主办的自然科学综合性学术刊物。它以“三个代表”、“科学发展观”为指导思想，以促进科学技术发展、培育科技人才，为我国社会主义现代化建设服务为宗旨。本刊坚持党的基本路线，提倡“双百方针”。刊登内容主要包括：船舶与海洋工程、机械、动力、能源、材料、电气、电子、信息与控制、计算机、化工、生物工程、建筑、管理科学以及数学、物理、工程力学等方面的最新研究成果。本刊为中国科技论文统计源核心期刊，并被《美国工程索引》（EI）等国内、外众多权威检索系统所收录。为保证刊物质量，根据国家标准和本刊的编排规则，特制定本简则。
> 
> 1     投稿约定
> 
> 1.1来稿须具有创新性、学术性、逻辑性和可读性。投稿网址：http://xuebao.sjtu.edu.cn。初审符合要求的稿件（必备：中图分类号，第一作者、通信作者简介，版权协议）即收稿并进入评审程序。
> 1.2 来稿切勿一稿两投或多投。文稿自收到之日起，审稿周期为4个月，逾期未收到稿件审理结果的请及时向编辑部查询。来稿一律不退回，请自留底稿。
> 
> 1.3 编辑部将按照规范的程序，聘请校外有关同行专家评审（二审制）和学报编委终审；编辑部将根据评审意见公平、公正地决定稿件的取舍。
> 
> 1.4 本刊现为纸张印刷版—光盘版—网络版三位一体的出刊模式，凡本刊刊用的稿件，将同时编入《中国学术期刊（光盘版）》。
> 
> 1.5 稿件文责自负。编辑部对来稿有权作技术性和文字性修改，实质性内容修改须征得作者同意。
> 
> 1.6 学报付印前按校样页数向作者收取发表费。印出后按篇酌致稿酬，并赠送当期学报样刊。
> 
> 2     来稿要求和注意事项
> 
> 2.1 来稿要求论点明确、数据可靠、逻辑严密、文字精炼。文稿具体格式请参见本编辑部网站模板，必须包括：中英文题名，全部作者姓名、单位、城市和邮编，摘要，关键词；中图分类号，正文（1万字以内），参考文献。基金项目及其编号，第一作者、通信作者简介著录于首页地脚。
> 2.2 题名应恰当简明地反映文章的特定内容，不使用非公知公用的缩略词、首字母缩写字符、代号等；有副标题时加破折号叠排在文题下，避免用“……的研究”等非特定词，中文题名一般不超过20个汉字，英文题名应与中文题名含义一致。
> 2.3 摘要应写成报道性文体，其内容独立于正文，采用第三人称的写法，不使用“本人”、“本文”、“作者”等作为主语，不分段，不标注文献号，尽量不用公式。中文摘要不少于250字，英文摘要（150 words左右）须与中文摘要相对应。摘要应回答好以下四方面问题：①目的(What you want to do(直接给出研究目的))；②方法(How you did it(详细陈述过程和方法))；③结果和结论(What results did you get and what conclusion can you draw(全面罗列结果和结论))；④文章的创新之处(What is original in your paper)。
> 2.4 关键词选词要规范，应尽量从《汉语主题词表》和标题中选取(3个以上)。未被词表收录的新学科、新技术中的重要术语，列于主题词后。中英文关键词应一一对应。中文关键词不用缩略词，写出中文全称。英文缩略关键词先写全称，括号中加缩略词。此外，请列出一些所属学科分类（包括大类与细分的小类）的关键词（读者在线模糊检索时常用到的词），以便于增大被检索到的概率。
> 2.5 论文（含图表）中的量和单位的使用应严格按GB3100～3102-93《量和单位》执行。不允许使用不规范的量的名称、符号及非法定计量单位。同一篇文章中，一个字母不能表示两种物理量，也不能用不同的字母表示不同状态下的同一个物理量，更不允许同一个物理量有几种不同的表示方式。除了特别常用的符号外，一般符号必须说明含义。
> 2.6 文中图、表应有自明性，且随文出现。图、表名应附相应的英文名。插图须符合制图规范。EPS（或PDF）：矢量绘图，嵌入所有使用的字体；TIFF（或JPEG）：彩色或灰度照片（半色调），至少300 dpi；TIFF（或JPEG）：Bitmapped（纯黑色和白色像素）线图，至少1000 dpi；TIFF（或JPEG）：点阵组合线/半色调（彩色或灰度），至少500 dpi。图中文字、符号、纵横坐标中的标值、标值线必须写清，标目应使用法定计量单位（一般不用中文表示）。文中表格一律使用“三线表”，表的内容切忌与图和文字内容重复。
> 2.7 文稿章节编号采用三级标题顶格排序。一级标题如0, 1，2，3，…排序，二级标题形如1.1，1.2；2.1，2.2，…排序，三级标题形如1.1.1，1.1.2，…；2.1.1，2.1.2，…排序，引言不排序。
> 
> 2.8 参考文献应是近5年国内外正式发表且已在文中标出引用之处的各类文献。以5篇以上为宜，其中80%应为期刊或会议论文，80%以上为近5年出版的文献，50%以上为外文文献。各类文献的著录格式如下：①期刊：作者.题名[J].刊名，出版年份，卷（期）：起止页码；②专著：作者.书名.版本（第1版免注）[M].出版地：出版者，出版年：起止页码；③论文集：作者.题名[A].见（ln）：编者.论文集名[C].出版地：出版者，出版年：起止页码；④学位论文：作者.题名[D].保存地址：保存单位，年份；⑤专利文献：专利申请者.题名[P].专利国别，专利文献种类，专利号.出版日期；⑥科学技术报告：作者.题名[R].报告题名，编号.出版地：出版者，出版年：起止页码；⑦电子文献：作者.题名[EB/OL].电子文献地址.发表或更新日期/引用日期.文献作者3名以内全部列出，4名以上只列前3名，后加“，等”或“，et al”；外文作者姓前名后，名用缩写，不加缩写点。对非英文文献，先按原文列出该文献，然后另起一行附上其英文译文。
> 
> 3 网上检索
> 
> 中国知网：http://navi.cnki.net/knavi/JournalDetail?pcode=CJFD&pykm=SHJT 或 http://www.cnki.net；
> 
> 万方数据系统科技期刊群：http://www.wanfangdata.com.cn/sns/user/qkshj2；
> 
> 《美国工程索引》（Ei）：https://www.engineeringvillage.com。
> ```
>
...
```
2019-12-12 08:38:39		2019-12-12 09:07:41		编码-Python
2019-12-12 09:15:09		2019-12-12 10:11:19		ADRC
2019-12-12 10:26:37		2019-12-12 10:58:58
2019-12-12 11:06:55		2019-12-12 11:58:38		编码-Python
2019-12-12 13:10:02		2019-12-12 13:33:07		ADRC
2019-12-12 13:42:09		2019-12-12 14:28:08		
2019-12-12 14:38:18		2019-12-12 15:43:13
2019-12-12 15:53:07		2019-12-12 16:45:28
2019-12-12 16:51:48		2019-12-12 17:24:34		文档

2019-12-13 11:11:29	2019-12-13 12:00:23	ADRC
2019-12-13 13:10:29	2019-12-13 13:57:23
2019-12-13 13:58:56	2019-12-13 15:07:42

2019-12-14 08:33:44	2019-12-14 09:14:08	编码-Python
2019-12-14 09:25:52	2019-12-14 10:48:10	ADRC
2019-12-14 10:52:26	2019-12-14 12:00:00	扩张观测器原理
2019-12-14 13:05:21	2019-12-14 14:10:13	参数调试	
2019-12-14 14:15:25	2019-12-14 18:15:25	文档整理
```
...
7.[论文大纲](<https://mm.edrawsoft.cn/map.html?obj=qqDECC8DABBFB246A3DCB61DA911808C52/Personal/Paper.emmx>)

8.电机三种控制方式

<https://zhuanlan.zhihu.com/p/40511239>

9.低效率

10.just give me a reason GUI
...
（1）编码能力、（2）控制专业知识、（3）广度和深度

（4）控制算法

9.做事的过程中是否应该参考质变和量变的关系；
...
15.你觉得你该拥有，另外一句话叫你凭什么觉得你值得拥有？

16.大牛

（1）解决问题的能力

17.当你感觉到需要在某些方面加强时，那表明真的需要强化了；

18.“虚假的动机”，又或者可以叫做表面动机，隐藏在表面动机的下面的就是内心真正的渴望；
...
27.任何的负面情况都是这人生、生活、路上的组成；都是需要面对和处理的；

28.解决问题才能实现突破，能解决的问题越难，取得的突破更大；

29.问题！我每天都在花时间解决什么问题，时间背后更深层次的东西；