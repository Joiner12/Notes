...
![](C:\Users\10520\Desktop\Notes\track对比-1.bmp)

仿真结果（diff对比）

<img src="C:\Users\10520\Desktop\Notes\diff对比.bmp" style="zoom:80%;" />
...
在不对噪声信号进行放大的基础上，降低跟踪信号相位滞后。从仿真结果看，随着待跟踪正弦信号频率增加，复合微分跟踪器的相位滞后相比较于一般形式的微分跟踪器，其相位滞后更小，且在微分信号上更为准确。
